...
describe('Service Tests', () => {
  describe('Network Service', () => {
    ...
    let elemDefault: INetwork;
    let expectedResult: INetwork | INetwork[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Network(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Network', () => {
        ...
        service.create(new Network()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Network', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            type: 'BBBBBB',
